  ...
  return (
    list ?
        <article className={`${styles.listContainer}`}>
          <a href={`/graduates/${data._id}#GradShow`} target="_blank" rel="noreferrer">
      ...
      <article className={styles.cardContainer}>
        ...
        <footer className={styles.footer}>
          ...
          <OutlineBtn linkers text='view' linkTo={`/graduates/${data._id}#GradShow`} height="thin" abmajor={`${abMajor[0].toString()}`} external/>
        </footer>
      </article>
  )
}
